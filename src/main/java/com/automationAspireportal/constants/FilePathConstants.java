...
public class FilePathConstants {
	...
	public final static String employeetimesheet_locators = USER_HOME + File.separator + "src/main/resources"
			+ File.separator + "locators" + File.separator + "atmecs" + File.separator + "employeetimesheet.properties";
	...
	public final static String EMPLOYEE_credentials = USER_HOME + File.separator + "src/main/resources" + File.separator
			+ "testdata" + File.separator + "employeemodule.xlsx";
